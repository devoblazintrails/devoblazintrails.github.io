...
<a href="https://calendar.app.google/KtFfzRHRmS41CmtZ7" target="_blank" rel="noopener noreferrer">
  <button class="large-centered-button"; style="background-color: #133f69; color: #c2b280; padding: 12px 20px; border: none; border-radius: 8px; font-size: 16px; cursor: pointer;">
    Schedule a Call
  </button>
</a>
